...
$autorIDQuery = "SELECT * FROM (autor a INNER JOIN autor_smer a_s ON a.id = a_s.autor_id) INNER JOIN smer s ON a_s.smer_id = s.id;";
...
<div class="container d-flex justify-content-center">
    ...
    <form action="../saves/saveDilo.php" method="POST">
        <div class="knihy-forms">
            ...
            <div class="input-group mb-1">
                <label class="input-group-text" for="inputGroupSelect04">Kompozice</label>
                <select name="kompozice[]" class="form-select" id="inputGroupSelect04" style="overflow: auto;" required multiple>
                    <option value="Chronologická">Chronologická</option>
                    <option value="Retrospektivní">Retrospektivní</option>
                </select>
            </div>
            <div class="input-group mb-1">
                ...
                <div id="drama-input" class="showNone">
                    ...
                    <div id="postavaD">
                        <div class="input-group mb-1">
                            ...
                            <select name="vlastnostiD[]" class="form-select" id="inputGroupSelect02" style="overflow: auto;">
                                <option value="Kladná">Kladná</option>
                                <option value="Záporná">Záporná</option>
                            </select>
                            <select name="literarniTypD[]" class="form-select" id="inputGroupSelect02" style="overflow: auto;">
                                <option value=""></option>
                                <option value="Literární">Literární</option>
                                <option value="Historická">Historická</option>
                            </select>
            ...
            <div class="input-group mb-1">
                ...
                <select name="autor" class="form-select" id="inputGroupSelect03">
                    ...
                    {
                        option($autor[$i][0], $autor[$i][1] . " " . $autor[$i][2] . " | " . $autor[$i][8] . " | " . $autor[$i][3]);
                    }
                    ?>
                </select>
            </div>
