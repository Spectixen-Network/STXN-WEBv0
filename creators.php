...
<div class="container-fluid d-flex" style="justify-content: center;">
    <div class="card col-sm-4" style="width:450px; text-align: center;" id="card">
        ...
        <div class="card-body">
            ...
            <p class="card-text text-primary">Fan of games and TV series. Interested in the entire backend spectrum and working on ambitious projects.</p>
            <div class="container-fluid d-flex" style="text-align: center; font-size: 3em;"><span class="col-sm-4"><a href="#"><i class="bi bi-discord"></i></a></span><span class="col-sm-4"><a href="#"><i class="bi bi-twitter"></i></a></span><span class="col-sm-4"><a href="#"><i class="bi bi-instagram"></i></a></span></div>
